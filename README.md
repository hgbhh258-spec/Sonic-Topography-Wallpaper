...
> ✅ **Supports both [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3747503071) and [Octos](https://github.com/underpig1/octos).** Note: Wallpaper Engine doesn't support scroll-wheel zoom on web wallpapers, so an on-screen zoom button is included as a workaround. Octos natively supports scroll-wheel zoom.
...
## Using as a Desktop Wallpaper

### Option 1: Wallpaper Engine

Search **"Sonic Topography Wallpaper"** in [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3747503071)'s workshop and apply it directly.

> Wallpaper Engine doesn't support scroll-wheel zoom for web wallpapers, so an on-screen zoom button is included as a workaround.

### Option 2: Octos

[Octos](https://github.com/underpig1/octos) is a free, open-source HTML dynamic desktop engine for Windows that renders web pages as live wallpapers with full mouse interactivity and multi-monitor support — including native scroll-wheel zoom.
...
> ✅ **已同时适配 [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3747503071) 与 [Octos](https://github.com/underpig1/octos)。** 注：Wallpaper Engine 不支持网页壁纸的滚轮缩放，因此加入了屏幕内置缩放按钮作为替代方案；Octos 原生支持滚轮缩放。
...
**方式一：Wallpaper Engine**

在 [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3747503071) 创意工坊中搜索 **"Sonic Topography Wallpaper"** 即可找到并直接应用。

> 注：Wallpaper Engine 不支持网页壁纸的滚轮缩放，因此加入了屏幕内置缩放按钮作为替代方案。

**方式二：Octos**

[Octos](https://github.com/underpig1/octos) 是一款免费开源的 Windows HTML 动态桌面引擎，可将网页渲染为带完整鼠标交互的实时动态壁纸，支持多显示器及原生滚轮缩放。
