...
> ✅ **Supports both [Wallpaper Engine](https://www.wallpaperengine.io/) and [Octos](https://github.com/underpig1/octos).** Note: Wallpaper Engine doesn't support scroll-wheel zoom on web wallpapers, so an on-screen zoom button is included as a workaround. Octos natively supports scroll-wheel zoom.
...
Search **"Sonic Topography Wallpaper"** in [Wallpaper Engine](https://www.wallpaperengine.io/)'s workshop and apply it directly.
...
> ✅ **已同时适配 [Wallpaper Engine](https://www.wallpaperengine.io/) 与 [Octos](https://github.com/underpig1/octos)。** 注：Wallpaper Engine 不支持网页壁纸的滚轮缩放，因此加入了屏幕内置缩放按钮作为替代方案；Octos 原生支持滚轮缩放。
...
在 [Wallpaper Engine](https://www.wallpaperengine.io/) 创意工坊中搜索 **"Sonic Topography Wallpaper"** 即可找到并直接应用。
